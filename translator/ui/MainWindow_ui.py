...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setStyleSheet("QPushButton {background-color: transparent; border: 0; font-size: 14px} QPushButton:hover {background-color: rgb(220, 220, 220);}")
        ...
        self.textBrowser_2.setMinimumSize(QtCore.QSize(390, 260))
