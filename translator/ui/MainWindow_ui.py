...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setStyleSheet("QPushButton {border-image: url(\":images/top_hint_off.png\"); border: 0; font-size: 14px} QPushButton:hover {background-color: rgb(220, 220, 220);} QPushButton:pressed {background-color: rgb(200, 200, 200);}")
