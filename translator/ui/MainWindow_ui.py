...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setStyleSheet("QPushButton {background-color: transparent; border: 0; font-size: 14px} QPushButton:hover {background-color: rgb(220, 220, 220);} QPushButton:pressed {background-color: rgb(200, 200, 200);}")
        ...
        self.pushButton_3.setMinimumSize(QtCore.QSize(42, 30))
