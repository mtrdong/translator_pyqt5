...
class Ui_MainWindow(object):
    def setupUi(self, Form):
        ...
        self.pushButton.setStyleSheet("QPushButton {background-color: transparent; border: 1px solid transparent;} QPushButton:hover {background-color: rgb(230, 230, 230); border: 1px solid rgb(230, 230, 230);} QPushButton:pressed {background-color: rgb(200, 200, 200); border: 1px solid rgb(200, 200, 200);}")
        self.pushButton.setObjectName("pushButton")
        self.horizontalLayout.addWidget(self.pushButton)
        self.pushButton_2 = QtWidgets.QPushButton(self.widget)
        self.pushButton_2.setMinimumSize(QtCore.QSize(42, 30))
        self.pushButton_2.setStyleSheet("QPushButton {background-color: transparent; border: 1px solid transparent;} QPushButton:hover {background-color: rgb(228, 104, 85); border: 1px solid rgb(228, 104, 85);} QPushButton:pressed {background-color: rgb(196, 94, 74); border: 1px solid rgb(196, 94, 74);}")
        ...
        self.widget_2 = MyWidget(self.widget)
        self.widget_2.setMinimumSize(QtCore.QSize(0, 100))
        self.widget_2.setObjectName("widget_2")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget_2)
        self.verticalLayout_3.setContentsMargins(10, 8, 10, 10)
        ...
        self.pushButton_4.setStyleSheet("QPushButton {background-color: transparent; border: 1px solid transparent; font-size: 18px}")
        ...
        self.pushButton_5.setStyleSheet("QPushButton {background-color: rgba(0, 0, 0, 80); border: 0px; border-radius: 9px; font-size: 8px; color: rgb(255, 255, 255);}")
        ...
        self.pushButton_6.setStyleSheet("QPushButton {background-color: transparent; border: 1px solid transparent; font-size: 16px}")
        ...
        self.pushButton_7.setStyleSheet("QPushButton {background-color: transparent; border: 1px solid transparent; font-size: 16px}")
        ...
        self.pushButton_8.setStyleSheet("QPushButton {background-color: transparent; border: 1px solid transparent; font-size: 16px}")
        ...
        self.pushButton_9.setStyleSheet("QPushButton {background-color: transparent; border: 1px solid transparent; font-size: 16px}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "目标语言"))
        self.pushButton_3.setText(_translate("Form", "翻译"))
        self.pushButton_4.setToolTip(_translate("Form", "截屏翻译（F1）"))
        self.pushButton_4.setText(_translate("Form", "📸"))
        self.checkBox.setToolTip(_translate("Form", "Ctrl+C 快速发起翻译"))
        self.checkBox.setText(_translate("Form", "划词翻译"))
        self.textEdit.setPlaceholderText(_translate("Form", "输入文字/拖入图片"))
        self.pushButton_5.setText(_translate("Form", "╳"))
        self.pushButton_6.setToolTip(_translate("Form", "语音播报"))
        self.pushButton_6.setText(_translate("Form", "🔊"))
        self.pushButton_7.setToolTip(_translate("Form", "复制内容"))
        self.pushButton_7.setText(_translate("Form", "📑"))
        self.pushButton_8.setToolTip(_translate("Form", "语音播报"))
        self.pushButton_8.setText(_translate("Form", "🔊"))
        self.pushButton_9.setToolTip(_translate("Form", "复制内容"))
