...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setStyleSheet("QPushButton {background-color: transparent; border: 0;} QPushButton:hover {background-color: rgb(230, 230, 230); border: 0;} QPushButton:pressed {background-color: rgb(200, 200, 200); border: 0;}")
        self.pushButton.setObjectName("pushButton")
        self.horizontalLayout.addWidget(self.pushButton)
        self.pushButton_2 = QtWidgets.QPushButton(MainWindow)
        self.pushButton_2.setMinimumSize(QtCore.QSize(42, 30))
        self.pushButton_2.setStyleSheet("QPushButton {background-color: transparent; border: 0;} QPushButton:hover {background-color: rgb(228, 104, 85); border: 0;} QPushButton:pressed {background-color: rgb(196, 94, 74); border: 0;}")
        ...
        self.pushButton_5.setStyleSheet("QPushButton {background-color: rgba(0, 0, 0, 80); border: 0; border-radius: 9px; font-size: 8px; color: rgb(255, 255, 255);}")
